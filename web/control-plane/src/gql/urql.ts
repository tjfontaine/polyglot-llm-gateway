...
export type Scalars = {
  ...
  Int64: { input: number | string; output: number | string; }
  JSON: { input: Record<string, unknown> | unknown[] | string | number | boolean | null; output: Record<string, unknown> | unknown[] | string | number | boolean | null; }
