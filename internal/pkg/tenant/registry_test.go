...
func TestMain(m *testing.M) {
	provider.ClearFactories()
	registration.RegisterProviderBuiltins()
	os.Exit(m.Run())
}
...
func (m *mockProviderRegistry) CreateProviders(configs []config.ProviderConfig) (map[string]ports.Provider, error) {
