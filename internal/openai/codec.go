// Codec provides conversion between OpenAI API format and canonical format.
package openai
...
// NewCodec creates a new OpenAI codec.
func NewCodec() *Codec {
	return &Codec{}
}
...
func APIRequestToCanonical(apiReq *ChatCompletionRequest) *domain.CanonicalRequest {
...
func CanonicalToAPIRequest(req *domain.CanonicalRequest) *ChatCompletionRequest {
...
func APIResponseToCanonical(apiResp *ChatCompletionResponse) *domain.CanonicalResponse {
...
func CanonicalToAPIResponse(resp *domain.CanonicalResponse) *ChatCompletionResponse {
...
func APIChunkToCanonical(chunk *ChatCompletionChunk) *domain.CanonicalEvent {
...
func CanonicalToAPIChunk(event *domain.CanonicalEvent, metadata *codec.StreamMetadata) *ChatCompletionChunk {
	...
	if event.ToolCall != nil {
		chunk.Choices[0].Delta.ToolCalls = []ToolCallChunk{
			{
